    ...
    return (
        <div className=' container mx-auto py-8 px-4 md:px-16 lg:px-24'>
            ...
            <div className=' mt-6 p-4 rounded-lg bg-gray-100'>
                ...
                <div className='mt-6'>
                    <button className=' ml-4 bg-green-500 text-white py-2 px-4 hover:bg-green-600'> Order tracking</button>
                    <button className=' ml-4 bg-red-600 text-white py-2 px-4 hover:bg-red-800'> Continue Shopping</button>
                </div>
            </div>
        </div>
    )
